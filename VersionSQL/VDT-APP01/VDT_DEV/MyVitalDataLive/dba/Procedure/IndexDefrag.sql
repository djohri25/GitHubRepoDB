/****** Object:  Procedure [dba].[IndexDefrag]    Committed by VersionSQL https://www.versionsql.com ******/

 
 
CREATE PROCEDURE [dba].[IndexDefrag]
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            /* Log our actions */
            INSERT INTO dba.IndexDefragLog
            (
                  databaseID
                , databaseName
                , objectID
