/****** Object:  Procedure [dbo].[uspCFR_HighCost_COPD_4X_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_COPD_4X_MVDID] 
AS
/*
    CustID:  16
    RuleID:  284
...
Changes
WHO		WHEN		WHAT
Scott	2020-10-20	Create as MERGE CFR only
Scott	2020-11-02	Update history to record ModifiedDate as GETUTCDATE and ModifiedBy as 'MERGE' 
Scott	2021-03-24	Refactor to CTE form for performance and clarity
Scott	20210514	Add Universal Exclusion for hourly and no benefit.
Scott	2021-08-02	Add new exclusion code

EXEC uspCFR_HighCost_COPD_4X_MVDID --(4807/:15)(4807/:06)
