/****** Object:  Procedure [dbo].[Get_UsersCareQForAssignment_WIP]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE
[dbo].[Get_UsersCareQForAssignment_WIP]
(
	@CustID bigint,
	@ProductID bigint,
	@County varchar(100),
...
-- Filter any parameter
	...
	* 
	...
	DECLARE @Tomorrow datetime = DATEADD( DAY, 1, getUTCDate() )
