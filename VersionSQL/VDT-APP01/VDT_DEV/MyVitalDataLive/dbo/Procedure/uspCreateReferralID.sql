/****** Object:  Procedure [dbo].[uspCreateReferralID]    Committed by VersionSQL https://www.versionsql.com ******/
...
create  PROCEDURE [dbo].[uspCreateReferralID] 
(			@DocID bigint =null
		...
		SET NOCOUNT ON
				...
				values (	@DocID  
						   ...
						   set @ReferralId=scope_identity()
						    select @ReferralId from MemberReferral
