/****** Object:  Procedure [dbo].[CopyNPIRecordToNPICustom]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[CopyNPIRecordToNPICustom]
	@NPI varchar(20)
AS
BEGIN
	SET NOCOUNT ON;

if not exists(select npi from LookupNPI_custom where npi = @npi)
begin
