/****** Object:  Procedure [dbo].[uspCFR_HighCost_AMR_LO_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_AMR_LO_MVDID] 
AS
/*
...
Scott	20210520	Add Universal Exclusions and format to CTE.
Scott	20210820	Add new exclusion code
...
EXEC uspCFR_HighCost_AMR_LO_MVDID   --(17145/15:48)

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_HighCost_AMR_LO_MVDID', @CustID = 16, @RuleID = 250, @ProductID = 2, @OwnerGroup = 168

EXEC uspCFR_MapRuleExclusion @RuleID = 250, @Action='DISPLAY'

*/
BEGIN
	SET NOCOUNT ON;

	DECLARE @RuleID int = 250
