/****** Object:  Procedure [dbo].[Import_Claim_Single]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Import_Claim_Single]
    @recordId int,
	-- Claim info
...
declare
	...
	BEGIN TRY
		...
		begin
			...
			IF @HPCustomerId = 11
			BEGIN
			--(c2.proccd = '99281' or c2.proccd = '99282' or c2.proccd = '99283' or c2.proccd = '99284' or c2.proccd = '99285') 
			-- Turned on for Driscoll  1/12/2015
			if @ProcedureCode IN ('99281','99282','99283','99284','99285')
			begin
				set @VisitType = 'ER'
			end
