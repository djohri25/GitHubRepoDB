/****** Object:  Procedure [dbo].[Get_DRGroupAssociatedPCPs_WithNames]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Get_DRGroupAssociatedPCPs_WithNames]
	@DrGroupID int,
	@TIN varchar(20) = null
AS
BEGIN
