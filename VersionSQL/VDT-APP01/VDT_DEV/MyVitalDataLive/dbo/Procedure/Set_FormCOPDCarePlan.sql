/****** Object:  Procedure [dbo].[Set_FormCOPDCarePlan]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- exec [Set_FormCOPDCarePlan] 'GW439227','1','Staff', '4/19/2016', 'M', '4/19/1962', 'IT Test Plan 1', '992795739299'
-- select * from FormCOPDCarePlan

CREATE PROCEDURE [dbo].[Set_FormCOPDCarePlan]
		   @MVDID varchar(20),
           @CustID varchar(20),
           ...
           @ME10 varchar(500)=NULL,
           @ME11 varchar(500)=NULL,
...
BEGIN
 ...
 INSERT INTO FormCOPDCarePlan
    ...
    select @noteText = 'Form COPD Care Plan Saved. '
 ...
 values(@MVDID,@noteText,0,GETUTCDATE(),@StaffInterviewing,@UserType,GETUTCDATE(),@StaffInterviewing,@UserType,0,0,0,0,'COPD',@FormID)
