/****** Object:  Procedure [dbo].[DashboadCareflowList]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		<Author,,Name>
-- Create date: <Create Date,,>
-- Description:	<Description,,>
-- EXEC dbo.DashboadCareflowList @UserID=N'FE1BFC9B-AD29-4540-BE3A-9872D3E5F094',@Customer='10'
-- Date			Name			Comments				
-- =============================================
CREATE PROCEDURE [dbo].[DashboadCareflowList] 
	 @UserID varchar(50)
	,@DateRange int = 0
	,@Customer varchar(50)
	,@IsCompleted bit = 0
