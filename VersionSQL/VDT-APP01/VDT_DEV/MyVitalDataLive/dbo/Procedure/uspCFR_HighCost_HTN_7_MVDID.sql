/****** Object:  Procedure [dbo].[uspCFR_HighCost_HTN_7_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_HTN_7_MVDID] 
AS
/*
...
Scott	20210428	Reformat as CTE
Scott	20210428	Add Universal Exclusion for Hourly and No Benefit
Scott	2021-09-07	Add query hints for Computed Care Queue

EXEC uspCFR_HighCost_HTN_7_MVDID  --(30/:04)(30/:02)

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_HighCost_HTN_7_MVDID', @CustID = 16, @RuleID = 229, @ProductID = 2, @OwnerGroup = 161

EXEC uspCFR_MapRuleExclusion @RuleID = '229', @Action = 'DISPLAY'

*/
BEGIN
	SET NOCOUNT ON;

	DECLARE @RuleID int = 229
