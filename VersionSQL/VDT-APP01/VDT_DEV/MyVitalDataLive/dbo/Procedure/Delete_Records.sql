/****** Object:  Procedure [dbo].[Delete_Records]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Delete_Records] 
...
BEGIN
    ...
    DELETE MainICENUMBERGroups WHERE ICENUMBER = @IceNumber
