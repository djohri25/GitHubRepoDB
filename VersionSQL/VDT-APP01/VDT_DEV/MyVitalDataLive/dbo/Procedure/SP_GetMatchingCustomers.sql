/****** Object:  Procedure [dbo].[SP_GetMatchingCustomers]    Committed by VersionSQL https://www.versionsql.com ******/
...
--		arguments. 
-- @SearchStatus: 0 - success, -1 - failed, -2 - search result exceed the limit
-- =============================================
CREATE PROCEDURE [dbo].[SP_GetMatchingCustomers]
...
--set @criteria = '<CRITERIA><CRITERION><NAME>HEALTHPLANID</NAME><VALUE></VALUE></CRITERION><CRITERION><NAME>MYVITALDATAID</NAME><VALUE>BS874327</VALUE></CRITERION><CRITERION><NAME>PATIENTINSURANCEID</NAME><VALUE></VALUE></CRITERION></CRITERIA>'
--set @outputlimit = 10
--
--set @criteria = '<CRITERIA><CRITERION><NAME>PATIENTINSURANCEID</NAME><VALUE>B3222234</VALUE></CRITERION></CRITERIA>'
--set @outputlimit = 10
...
--			@Gender  as 'Gender', @DOB as 'DOB'
		...
		begin
			...
			if isnull(@MVDID,'') = ''
			begin
				select @mvdid = icenumber  from maininsurance 
				where medicaid = @insID 
			end			
		end
		...
		from dbo.MainPersonalDetails a
			left join Link_MVDID_CustID li on a.icenumber = li.mvdid
