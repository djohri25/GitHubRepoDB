/****** Object:  Procedure [dbo].[uspCFR_Maternity_Diabetes_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_Maternity_Diabetes_MVDID] 
AS
/*
    CustID:  16
    RuleID:  293
...
Mike	2021-07-27	Borrow base rule and segment for just Diabetes (TFS 5793)

exec uspCFR_Maternity_Diabetes_MVDID

exec uspCFR_Merge @MVDProcedureName = 'uspCFR_Maternity_Diabetes_MVDID', @CustID = 16, @RuleID = 293, @ProductID = 2, @OwnerGroup = 156

*/
BEGIN
	SET NOCOUNT ON;

	DECLARE @RuleID int = 293
