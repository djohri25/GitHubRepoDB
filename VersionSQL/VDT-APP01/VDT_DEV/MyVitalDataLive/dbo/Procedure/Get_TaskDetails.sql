/****** Object:  Procedure [dbo].[Get_TaskDetails]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE procedure [dbo].[Get_TaskDetails] 
	@CustomerId int,
	@ProductId int,
	@StatusId int = null,
	@PriorityId int = null,
...
where (task.Owner=@User or author = @Createdby)
and task.StatusId not in (@StatusId) and task.customerid=@CustomerId
