/****** Object:  Procedure [dbo].[GetDiabetesFormsInfo]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetDiabetesFormsInfo]
...
--@existGDCP bit
    ...
    @existAAF = 0,@existACP = 0,@existDCP = 0,
...
--END
	...
	select @age as 'age',@existsAAP as 'existsAAP', @showACT4_11yr as 'showACT4_11yr', 
		...
		@existAAF AS 'existAAF',@existACP AS 'existACP',@existDCP AS 'existDCP',
