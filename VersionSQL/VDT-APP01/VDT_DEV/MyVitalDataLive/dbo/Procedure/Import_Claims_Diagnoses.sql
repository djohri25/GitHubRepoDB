/****** Object:  Procedure [dbo].[Import_Claims_Diagnoses]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Import_Claims_Diagnoses]
	@RecordId int,
