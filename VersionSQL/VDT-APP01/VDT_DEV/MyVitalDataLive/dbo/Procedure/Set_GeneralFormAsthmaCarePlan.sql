/****** Object:  Procedure [dbo].[Set_GeneralFormAsthmaCarePlan]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Set_GeneralFormAsthmaCarePlan]
 @MVDID varchar(20),
 @CustID varchar(20),
...
@CommToProvider ,
 ...
 values(@MVDID,@noteText,0,GETUTCDATE(),@StaffInterviewing,@UserType,GETUTCDATE(),@StaffInterviewing,@UserType,0,0,0,0,'GACP',@FormID)
