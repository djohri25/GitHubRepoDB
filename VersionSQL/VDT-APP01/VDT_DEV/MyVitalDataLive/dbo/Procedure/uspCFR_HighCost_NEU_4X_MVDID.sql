/****** Object:  Procedure [dbo].[uspCFR_HighCost_NEU_4X_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_NEU_4X_MVDID] 
AS
/*
...
Scott	2021-03-25	Add Company Exclusions and rename to uspCFR_HighCost_NEU_4X_MVDID
...
EXEC uspCFR_HighCost_NEU_4X_MVDID -- (1285/.10)(1285/.07) 

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_HighCost_NEU_4X_MVDID', @CustID = 16, @RuleID = 288, @ProductID = 2, @OwnerGroup = 159

EXEC uspCFR_MapRuleExclusion @RuleID = '288', @Action = 'DISPLAY'

*/
BEGIN
	SET NOCOUNT ON;

	DECLARE @RuleID int = 288
