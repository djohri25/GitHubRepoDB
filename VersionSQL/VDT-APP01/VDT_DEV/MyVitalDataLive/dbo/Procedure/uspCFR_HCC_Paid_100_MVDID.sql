/****** Object:  Procedure [dbo].[uspCFR_HCC_Paid_100_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HCC_Paid_100_MVDID] 
AS
/*
			***Depends on CFR 219
...
EXEC uspCFR_HCC_Paid_100_MVDID  --(1018/:06)(1018/:03)
...
EXEC uspCFR_MapRuleExclusion @pRuleID = 259, @pAction = 'DISPLAY'
