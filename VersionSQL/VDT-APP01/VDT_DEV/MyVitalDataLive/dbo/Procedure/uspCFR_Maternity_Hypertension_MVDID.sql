/****** Object:  Procedure [dbo].[uspCFR_Maternity_Hypertension_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_Maternity_Hypertension_MVDID] 
AS
/*
    CustID:  16
    RuleID:  292
...
Mike	2021-07-27	Borrow base rule and segment for just Hypertension (TFS 5793)

exec uspCFR_Maternity_Hypertension_MVDID

exec uspCFR_Merge @MVDProcedureName = 'uspCFR_Maternity_Hypertension_MVDID', @CustID = 16, @RuleID = 292, @ProductID = 2, @OwnerGroup = 156

*/
BEGIN
	SET NOCOUNT ON;

	DECLARE @RuleID int = 292
