/****** Object:  Procedure [dbo].[uspSelectCareQueue2]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE
[dbo].[uspSelectCareQueue2]
(
	@UserName nvarchar(256),
	@UserID nvarchar(128),
	@CustomerID int,
	@ProductID int,
	@HCEmployeeOverride bit = NULL
)
AS
BEGIN
...
*/
	...
	IF ( @HCEmployeeOverride IS NULL )
	BEGIN
		SET @v_health_care_employee_override_yn = dbo.fnABCBSUserMemberCheck( @UserId );
	END;
	ELSE
	BEGIN
		SET @v_health_care_employee_override_yn = @HCEmployeeOverride;
	END;
...
*/
			...
			AND cft.ExpirationDate >= getDate()
		) m
