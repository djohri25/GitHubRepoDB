/****** Object:  Procedure [dbo].[Get_PatientEduPostPartumForm]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Get_PatientEduPostPartumForm]
...
SELECT TOP 1 pegp.*,
		d.FirstName,
		d.LastName FROM FormPatientEducationPostPartum pegp 
