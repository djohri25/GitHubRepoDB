/****** Object:  Procedure [dbo].[Get_MDPatientsByDoctor_Paging]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Get_MDPatientsByDoctor_Testing]
	@DoctorID varchar(20),
	@PCP_NPI varchar(20),
