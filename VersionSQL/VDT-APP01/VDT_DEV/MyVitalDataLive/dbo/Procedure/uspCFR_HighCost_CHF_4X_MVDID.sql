/****** Object:  Procedure [dbo].[uspCFR_HighCost_CHF_4X_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_CHF_4X_MVDID] 
AS
/*
    CustID:  16
    RuleID:  291
...
EXEC uspCFR_HighCost_CHF_4X_MVDID	--(12515/:25)
