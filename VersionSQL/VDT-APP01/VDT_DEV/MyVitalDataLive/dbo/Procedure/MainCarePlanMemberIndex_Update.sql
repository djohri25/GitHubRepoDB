/****** Object:  Procedure [dbo].[MainCarePlanMemberIndex_Update]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[MainCarePlanMemberIndex_Update]
...
if (@message = 'Activated') or (not exists (select top 1 1 from HPAlertNote where SessionID=@SessionID and NoteTypeID=@NoteTypeID ))
