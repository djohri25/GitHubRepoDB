/****** Object:  Procedure [dbo].[Import_Claims_Diag]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Import_Claims_Diag]
	...
	begin
		BEGIN TRY
			...
			begin
				...
				insert into MainConditionHistory (ICENUMBER, OtherName, Code, CodingSystem,ReportDate,CreationDate,CreatedBy,CreatedByOrganization,CreatedByNPI,UpdatedBy,UpdatedByOrganization,UpdatedByNPI,UpdatedByContact,RevCode,BillType,POS,DRGCode,DischargeStatus,AdmissionDate,DischargeDate,IsPrincipal)
				values(@MVDId, @Description, @DiagnosisCode, @CodingSystem, @ServDate, getutcdate(), @UpdatedBy, @Organization, @ServProvNPI, @UpdatedBy, @Organization, @ServProvNPI, @UpdatedByContact,@RevCode,@BillType,@POS,@DRGCode,@DischargeStatus,@AdmissionDate,@DischargeDate,@IsPrincipal)
