/****** Object:  Procedure [dbo].[uspCFR_Various_MA_Diabetes_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_Various_MA_Diabetes_MVDID]
AS
/*
...
Scott	2011-10-06	modify to use MA only after base table change.

EXEC uspCFR_Various_MA_Diabetes_MVDID  --(196/:02)

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_Various_MA_Diabetes_MVDID', @CustID = 16, @RuleID = 265, @ProductID = 2, @OwnerGroup= 171

EXEC uspCFR_MapRuleExclusion @RuleID = '265', @Action = 'DISPLAY'
