/****** Object:  Procedure [dbo].[Get_HEDIS_Summary]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Get_HEDIS_Summary]
	@Product int = 0,
	@CustID int,
	@TIN varchar(50) = 'ALL',
	@NPI varchar(50) = 'ALL',
