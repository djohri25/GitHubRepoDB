/****** Object:  Procedure [dbo].[uspCFR_HighCost_HTN_4_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_HTN_4_MVDID] 
AS
/*
...
Scott	2021-04-28	Add Universal Exclusion for no benefit and hourly.
Scott	2021-09-07	Add query hints for Computed Care Queue

EXEC uspCFR_HighCost_HTN_4_MVDID	-- (3836/.25)(3836/.05)

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_HighCost_HTN_4_MVDID', @CustID = 16, @RuleID = 230, @ProductID = 2, @OwnerGroup = 168

EXEC uspCFR_MapRuleExclusion @RuleID = '230', @Action = 'DISPLAY'
