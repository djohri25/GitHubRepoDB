/****** Object:  Procedure [dbo].[Set_ToDoHedisSummary]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE procedure [dbo].[Set_ToDoHedisSummary]
AS
BEGIN
	SET NOCOUNT ON;
...
where RoleID = 1 and isnull(NPI,'') <> '' and li.Cust_ID = 10
...
begin
	...
	begin
		...
		values(@npi,@tin, @testDueID,@patientCount,@totalTestCount,@totalCompletedCount,10)
