/****** Object:  Procedure [dbo].[uspCFR_HiAmt_Pended_MVDID_202010730]    Committed by VersionSQL https://www.versionsql.com ******/
...
EXEC uspCFR_HiAmt_Pended_MVDID 361/:02
...
SELECT @MaxRolling12 = Max(MonthID) FROM ComputedMemberTotalPendedClaimsRollling12
		...
		(
		 ...
		 LEFT JOIN ComputedMemberTotalPendedClaimsRollling12 CP on CP.MVDID = CCQ.MVDID
