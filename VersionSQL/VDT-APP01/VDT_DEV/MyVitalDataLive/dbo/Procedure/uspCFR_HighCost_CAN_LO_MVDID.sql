/****** Object:  Procedure [dbo].[uspCFR_HighCost_CAN_LO_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_CAN_LO_MVDID] 
AS
/*
...
EXEC uspCFR_HighCost_CAN_LO_MVDID (432/:15) (432/:12)
