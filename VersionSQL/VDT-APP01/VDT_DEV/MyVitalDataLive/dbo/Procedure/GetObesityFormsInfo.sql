/****** Object:  Procedure [dbo].[GetObesityFormsInfo]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[GetObesityFormsInfo]
...
--@existGDCP bit
    ...
    @existAAF = 0,@existACP = 0,@existDCP = 0,@existOCP = 0,
