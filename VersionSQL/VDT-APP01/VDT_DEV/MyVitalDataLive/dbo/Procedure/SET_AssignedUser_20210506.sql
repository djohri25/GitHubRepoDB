/****** Object:  Procedure [dbo].[SET_AssignedUser_20210506]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE
[dbo].[SET_AssignedUser_20210506]
(
	@CustID int = NULL,
	@ProductID int = 2,
...
-- interfering with SELECT statements.
	...
	BEGIN
		SET @User = dbo.Get_CareQForAdmissionAutoQ( @MVDID );
		SET @NewUser = @User;
	END
