/****** Object:  Procedure [dbo].[uspCFR_CancerWalMart_NonCOE_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_CancerWalMart_NonCOE_MVDID] 
AS
/*
    CustID:  16
    RuleID:  295
...
Rules: 
244 Walmart COE Cancer
245 Cancer - Non Walmart
295 Walmart Non COE Cancer  --this ID may change when it is deployed to Live.
...
EXEC uspCFR_CancerWalMart_NonCOE_MVDID   -- (4:54/134)  (3:38/134) (:54/588)

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_CancerWalMart_NonCOE_MVDID', @CustID = 16, @RuleID = 295, @ProductID = 2, @OwnerGroup= 168

SELECT * FROM LookupCodeTypeCondition WHERE NonCOE = 1 ORDER BY Code

SELECT * FROM HPWorkflowRule
SELECT * FROM Link_HPRuleAlertGroup
