/****** Object:  Procedure [dbo].[uspCFR_ERVisit_Strat269_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_ERVisit_Strat269_MVDID] 
AS
/*
	CustID:			16
	RuleID:			269
...
EXEC uspCFR_ERVisit_Strat269_MVDID --(2250/:00) (2250:00)

This procedure will may be called as

EXEC uspCFR_Merge @MVDProcedureName 'uspCFR_ERVisit_Strat269_MVDID', @CustID=16, @RuleID = 269, ProductID=2,@OwnerGroup = 170

EXEC uspCFR_MapRuleExclusion @RuleID = '269', @Action = 'DISPLAY'
