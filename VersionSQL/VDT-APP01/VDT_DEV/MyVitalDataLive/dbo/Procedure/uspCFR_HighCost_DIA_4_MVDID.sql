/****** Object:  Procedure [dbo].[uspCFR_HighCost_DIA_4_MVDID]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[uspCFR_HighCost_DIA_4_MVDID] 
AS
/*
...
Scott	2021-04-30	Add Universal Exclusion for no benefit and hourly.
Scott	2021-08-06  Add new exclusion code
Scott	2021-09-07	Add query hints for Computed Care Queue
Scott	2021-09-17	Add CCM Exclusions

EXEC uspCFR_HighCost_DIA_4_MVDID	--(5004/:24)(0/:13)  

EXEC uspCFR_Merge @MVDProcedureName = 'uspCFR_HighCost_DIA_4_MVDID', @CustID = 16, @RuleID = 233, @ProductID = 2, @OwnerGroup = 168

EXEC uspCFR_MapRuleExclusion @RuleID = '233', @Action = 'DISPLAY'
