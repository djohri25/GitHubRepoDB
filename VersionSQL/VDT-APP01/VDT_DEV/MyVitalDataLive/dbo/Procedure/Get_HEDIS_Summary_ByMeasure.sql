/****** Object:  Procedure [dbo].[Get_HEDIS_Summary_ByMeasure]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[Get_HEDIS_Summary_ByMeasure]
...
BEGIN
	...
	DECLARE @SubmeasureID int, @SubmeasureName varchar (100), @TestGoal DECIMAL(8,2), @testType VARCHAR(20)
	...
	SELECT @MeasureEndMonth = LEFT(MeasurementEnd, 2)
	...
	SELECT @TestGoal = [Goal], @testType = [Group]
