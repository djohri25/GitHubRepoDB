/****** Object:  View [dbo].[vwHPRuleAlertGroup]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[vwHPRuleAlertGroup] 
AS
     ...
     SELECT DB_Name() AS [Database], 
			...
			wfr.[Group],
			l.AlertGroup_ID, 
			ag.Name AS AlertGroupName, 
			q.OwnerGroup, 
			og.Name AS OwnerGroupName, 
			q.InQueue
